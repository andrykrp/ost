...
public class InfrastructureConfig {
    ...
    public static final String REPOSITORIES = "org.octocode.repositories";
    public static final String DOMAINS = "org.octocode.domain";
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan(REPOSITORIES, DOMAINS);
